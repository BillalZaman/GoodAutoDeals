...
public class CalendarView extends LinearLayout {
    ...
    public CalendarView(Context context, AttributeSet attrs) {
        ...
        selectedCalcender = Calendar.getInstance();
        initCalendar(selectedCalcender);
    }
    ...
    private void initCalendar(Calendar calendar) {
        mCalendarPageAdapter = new CalendarPageAdapter(mContext, mCalendarProperties, calendar);

        mViewPager.setAdapter(mCalendarPageAdapter);
        mViewPager.addOnPageChangeListener(onPageChangeListener);
        Log.d("bilalzaman12", "initCalendar: " + calendar.get(Calendar.MONTH));
...
//        if (calendar.get(Calendar.MONTH) == Calendar.getInstance().get(Calendar.MONTH)) {
        ...
        Log.d("myTalal", "setUpCalendarPosition: " + FIRST_VISIBLE_PAGE);
//        }
    ...
    private final ViewPager.OnPageChangeListener onPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            Log.d("talal123", "onPageSelected: "+position);
    ...
    private void callOnPageChangeListeners(int position) {
        if (position > mCurrentPage && mCalendarProperties.getOnForwardPageChangeListener() != null) {
            mCalendarProperties.getOnForwardPageChangeListener().onChange(true);
            Log.d("bilalzaman124", "getOnForwardPageChangeListener: "+mCurrentPage);
        }

        if (position < mCurrentPage && mCalendarProperties.getOnPreviousPageChangeListener() != null) {
            mCalendarProperties.getOnPreviousPageChangeListener().onChange(false);
            Log.d("bilalzaman124", "getOnPreviousPageChangeListener: "+mCurrentPage);
        }
    ...
    public void setDisabledDays(List<Calendar> disabledDays, Calendar calendar) {
        mCalendarProperties.setDisabledDays(disabledDays);
        mCalendarProperties.setDisabledDaysLabelsColor(Color.WHITE);
//        mCalendarProperties.setCalendar(calendar);
        Log.d("bilalzaman12", "setDisabledDays: " + calendar.get(Calendar.MONTH));
        mCurrentPage = 1200;
...
//
//            mCalendarPageAdapter.refreshList();
//        }
    }
