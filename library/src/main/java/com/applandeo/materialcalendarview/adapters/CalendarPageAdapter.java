...
public class CalendarPageAdapter extends PagerAdapter {
    ...
    Calendar selectedCalcendar;

    private int mPageMonth;

    CalendarDayAdapter calendarDayAdapter;

    public CalendarPageAdapter(Context context, CalendarProperties calendarProperties, Calendar _selectedCalcendar) {
        mContext = context;
        mCalendarProperties = calendarProperties;
        selectedCalcendar = _selectedCalcendar;
        informDatePicker();
    }
    ...
    private void loadMonth(int position) {
        ...
        calendarDayAdapter = new CalendarDayAdapter(this, mContext,
    ...
    public void refreshList() {
        if (calendarDayAdapter != null) {
            calendarDayAdapter.refreshList();
        }
    }
