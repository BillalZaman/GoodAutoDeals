...
import com.goodautodeal.goodautodeal.databinding.FragmentDraftBinding;
...
public class DraftFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_draft, container, false);
        ...
        viewModel.getUserData().observe(this, new Observer<Response>() {
            ...
            public void onChanged(@Nullable Response response) {
                if (response.getResp().getCode() == 1 &&
                    ...
                    if (response.getResp().getDataObject().getDraftAdList()!=null) {
                        data = response.getResp().getDataObject().getDraftAdList();
