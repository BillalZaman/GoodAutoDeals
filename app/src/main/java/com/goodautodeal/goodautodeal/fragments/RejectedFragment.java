...
import com.goodautodeal.goodautodeal.databinding.FragmentRejectedBinding;
        ...
        viewModel.getUserData().observe(this, new Observer<Response>() {
            ...
            public void onChanged(@Nullable Response response) {
                if (response.getResp().getCode() == 1 &&
                    ...
                    if (response.getResp().getDataObject().getRejectedAdList()!=null) {
                        data = response.getResp().getDataObject().getRejectedAdList();
