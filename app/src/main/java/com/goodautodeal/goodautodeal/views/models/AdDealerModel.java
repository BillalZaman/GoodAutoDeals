 ...
 */
public class AdDealerModel implements Serializable {
    @SerializedName("id")
    @Expose
    private Integer id;
    @SerializedName("slug")
    ...
    @Expose
    private String avgMontlySelling;
    ...
    public String getAvgMontlySelling() {
        return avgMontlySelling;
    }

    public void setAvgMontlySelling(String avgMontlySelling) {
