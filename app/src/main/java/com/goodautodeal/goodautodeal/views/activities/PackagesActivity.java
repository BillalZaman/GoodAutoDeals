...
public class PackagesActivity extends AppCompatActivity implements PaypalInterface {
    ...
    private void initData() {
        packagesModels.add(new PackagesModel("Silver", "£39.99", "2 weeks", "30", "0", "Depends on Search Criteria"));
        packagesModels.add(new PackagesModel("Gold", "£59.99", "4 weeks", "50", "1", "Depends on Search Criteria"));
        packagesModels.add(new PackagesModel("Diamond", "£69.99", "6 weeks", "50", "1", "Appears in top 100 in the Search Randomly"));
        packagesModels.add(new PackagesModel("Platinum", "£89.99", "6 weeks", "50", "1", "Depends on Search Criteria"));
