 ...
 */
public class DealerAdListViewRepository {
    ...
    public DealerAdListViewRepository(Application application) {
    ...
    public Observable<Response> getPublishedAds() {
        dataStatus.isLoadingList = true;
        status.setValue(dataStatus);

        ApiInterface apiInterface = ApiClient.getClient().create(ApiInterface.class);
        mainResponseObservable = apiInterface.getDealerPublishedAds("Bearer" + " " +
...
//                        Toast.makeText(application, "Success" + response.getResp().getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public Observable<Response> getPendingAds() {
        dataStatus.isLoadingList = true;
        status.setValue(dataStatus);

        ApiInterface apiInterface = ApiClient.getClient().create(ApiInterface.class);
        mainResponseObservable = apiInterface.getDealerPendingAds("Bearer" + " " +
                PreferenceHelper.getInstance().getString(ConstUtils.APIAccessToken, "")
        );
...
//                        Toast.makeText(application, "Success" + response.getResp().getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public Observable<Response> getRejectedAds() {
        dataStatus.isLoadingList = true;
        status.setValue(dataStatus);

        ApiInterface apiInterface = ApiClient.getClient().create(ApiInterface.class);
        mainResponseObservable = apiInterface.getDealerRejectedAds("Bearer" + " " +
                PreferenceHelper.getInstance().getString(ConstUtils.APIAccessToken, "")
        );
...
//                        Toast.makeText(application, "Success" + response.getResp().getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public Observable<Response> getSoldAds() {
        dataStatus.isLoadingList = true;
        status.setValue(dataStatus);

        ApiInterface apiInterface = ApiClient.getClient().create(ApiInterface.class);
        mainResponseObservable = apiInterface.getDealerSoldAds("Bearer" + " " +
                PreferenceHelper.getInstance().getString(ConstUtils.APIAccessToken, "")
        );
...
//                        Toast.makeText(application, "Success" + response.getResp().getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public Observable<Response> getDraftAds() {
        dataStatus.isLoadingList = true;
        status.setValue(dataStatus);

        ApiInterface apiInterface = ApiClient.getClient().create(ApiInterface.class);
        mainResponseObservable = apiInterface.getDealerDraftAds("Bearer" + " " +
                PreferenceHelper.getInstance().getString(ConstUtils.APIAccessToken, "")
        );
